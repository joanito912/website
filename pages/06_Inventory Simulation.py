...
def simulate_ddmrp_inventory(rop, max_qty, critical_level, moq, 
                           ...
                           beginning_inventory, inventory_value, sim_days=90, start_day=1):
    daily_avg_use = monthly_usage_avg / 30
    inventory = beginning_inventory
    day_numbers = [start_day]
    ...
    for day in range(start_day - 1, sim_days + start_day - 1):
        day_numbers.append(day + 1)
        inventory = max(0, inventory - daily_consumption[day - (start_day - 1)])
