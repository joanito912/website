...
#         
#         with col4:
#             st.empty()  # Empty column to maintain 5-column layout
#             
#     with st.container(border=True):
#         col1, col2, col3, col4 = st.columns(4)
#         
...
#                 outer_diameter_inch = round(outer_diameter_m / 0.0254, 2)  # Convert back to inches
#             else:
#                 outer_diameter_inch = 0.0
#             
#             st.metric("Outer Diameter (mm)", f'{outer_diameter_inch*25.4:.2f}')
#         
#         with col3:
#             # Create sketch
#             if outer_diameter_inch > 0 and core_diameter > 0:
#                 fig, ax = plt.subplots(figsize=(4, 4))
#                 
#                 # Draw outer circle
#                 outer_circle = plt.Circle((0, 0), outer_diameter_inch/2, fill=False, color='blue')
#                 ax.add_artist(outer_circle)
#                 
#                 # Draw core circle
#                 core_circle = plt.Circle((0, 0), core_diameter/2, fill=False, color='red')
#                 ax.add_artist(core_circle)
#                 
#                 # Annotations
#                 ax.annotate(f'Outer: {outer_diameter_inch*25.4:.2f} mm',
#                            xy=(0, outer_diameter_inch/2),
#                            xytext=(0, outer_diameter_inch/2 + 1),
#                            ha='center')
#                 ax.annotate(f'Core: {core_diameter}"',
#                            xy=(0, core_diameter/2),
#                            xytext=(0, core_diameter/2 + 1),
#                            ha='center')
#                 
#                 # Set limits and remove axes
#                 ax.set_xlim(-outer_diameter_inch/2 - 2, outer_diameter_inch/2 + 2)
#                 ax.set_ylim(-outer_diameter_inch/2 - 2, outer_diameter_inch/2 + 2)
#                 ax.set_aspect('equal')
#                 ax.axis('off')
#                 
#                 st.pyplot(fig)
